from model_uniform import Schelling
...
results = batch_run(Schelling, 
                    ...
                    iterations=50,
                    max_steps=100,
                    data_collection_period = 25) #how often do you want to pull the data
...
pd.DataFrame(results).to_csv("batch_data_uniform.csv")
