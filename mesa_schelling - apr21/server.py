import mesa
from model_beta import Schelling
...
model_params = {
    ...
    "homophily_mu": mesa.visualization.Slider(
        name="Expected Value of Homophily", value=0.3, min_value=0.1, max_value=0.9, step=0.1
    ),
    "tolerance": mesa.visualization.Slider(
        name="Tolerance", value=0.3, min_value=0, max_value=1, step=0.1
    ),
